...
export const mockEvents: ProjectEvent[] = [
  {
    id: "evt_00",
    projectId: "proj_progress_goat",
    title: "ProgressGoat foundation shipped",
    summary: "Next.js app shell, design tokens, and database schema landed.",
    source: "manual",
    eventType: "milestone.completed",
    occurredAt: "2026-06-01T09:00:00Z",
    endedAt: "2026-06-08T14:00:00Z",
  ...
  },
  {
    ...
    summary: "Warm cream canvas with moss green accents and editorial type.",
    source: "figma",
    eventType: "file.updated",
    occurredAt: "2026-06-08T14:00:00Z",
